...
const housingEndpoint = 'https://3eb77tteqe.execute-api.eu-central-1.amazonaws.com/dev/get-price';

// Endpoint URL for Named Entity Recognition roh https://jcndar8tde.execute-api.ap-south-1.amazonaws.com/dev/ner
//https://6q585ioqp2.execute-api.us-east-1.amazonaws.com/dev/path_ner
//Working
//https://jcndar8tde.execute-api.ap-south-1.amazonaws.com/dev/ner 
const nerEndpoint = 'https://6q585ioqp2.execute-api.us-east-1.amazonaws.com/dev/path_ner';

// Endpoint URL for PoS tagging and dependency parsing https://zb6cjea9yj.execute-api.eu-central-1.amazonaws.com/dev/ner

const parseEndpoint = 'https://8zshs78j11.execute-api.eu-central-1.amazonaws.com/dev/parse'; 

// S3 bucket name for image uploads
const uploadBucketName = 'image-upload-111';
...
const identityPoolId = 'ap-south-1:2fdd8af5-ce53-4114-98e1-dc8401fab522';

// Ednpoint URL for image classification with ResNet50 model# roh z6sqh3kiag, my g3ldv903w5

const resnet50Endpoint = 'https://g3ldv903w5.execute-api.ap-south-1.amazonaws.com/dev/classify';

// Endpoint URL for image classification with Inception V3 model
const inceptionV3Endpoint = 'https://j8no3rq51b.execute-api.ap-south-1.amazonaws.com/dev/classify_inception';
